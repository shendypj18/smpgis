...
{
    $sekolah=Sekolah::all();
    return view('user.beranda')->with(compact('sekolah'));
}
);
Auth::routes();
...
Route::get('/sekolahh','HomeController@sekolah')->name('user.sekolah');
...
Route::get('/rutejalan','HomeController@rekomendasi')->name('user.rekomendasisekolah');
