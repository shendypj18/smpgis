                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>{{$data->Link_Sekolah}}</td>
                              <td><a href="{{route('admin.edit.sekolah', $data->id)}}" class="btn btn-warning">Edit</a></td>
                              <td>
                                  <form class="" action="{{route('admin.delete.sekolah', $data->id)}}" method="post">
                                      {{csrf_field()}}
                                      {{method_field('delete')}}
