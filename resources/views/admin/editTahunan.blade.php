      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
              @include('admin.notif')
            <!-- Page Heading -->
            <form class="form-horizontal" action="{{route('admin.edit.tahunan.submit', $tahunan->id)}}" method="post">
                {{csrf_field()}}
                {{method_field('put')}}
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="nama_sekolah" class="form-control" value="{{$tahunan->nama_sekolah}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="passing_grade" class="form-control" value="{{$tahunan->passing_grade}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="kuota" class="form-control" value="{{$tahunan->kuota}}">
                    </div>
                </div>
                <!-- <div class="row">
                    <div class="col-md-3">
