      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
              @include('admin.notif')
            <!-- Page Heading -->
            <form class="form-horizontal" action="{{route('admin.tambah.data.tahunan.submit')}}" method="post">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="passing_grade" class="form-control" value="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="kuota" class="form-control" value="">
                    </div>
                </div>
                <!-- <div class="row">
                    <div class="col-md-3">
