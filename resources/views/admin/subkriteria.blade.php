...
<a href="{{route('admin.tambahsubkriteria')}}" class="btn btn-primary">Tambah Data Subkriteria</a>
                  <!-- DataTales Example -->
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                          ...
                          <td>{{$data->ba}}</td>
                          <td>{{$data->nilai}}</td>
                          <td><a href="{{route ('admin.editsubkriteria', $data->id)}}" class="btn btn-warning">Edit</a>
                          </td>
                          <td><form action="{{route('admin.delete.subkriteria', $data->id)}}" method='post'>
                          {{csrf_field()}}
                          {{method_field('delete')}}
