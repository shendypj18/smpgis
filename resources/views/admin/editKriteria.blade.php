      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
              @include('admin.notif')
            <!-- Page Heading -->
            <form class="form-horizontal" action="{{route('admin.edit.kriteria.submit', $kriteria->id)}}" method="post">
                {{csrf_field()}}
                {{method_field('put')}}
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="jenis_kriteria" class="form-control" value="{{$kriteria->jenis_kriteria}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
