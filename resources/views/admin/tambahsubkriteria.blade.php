      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
              @include('admin.notif')
            <!-- Page Heading -->
            <form class="form-horizontal" action="{{route('admin.subkriteria.submit')}}" method="post">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="subkriteria" class="form-control" value="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bb" class="form-control" value="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="ba" class="form-control" value="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
