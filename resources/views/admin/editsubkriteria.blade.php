      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
              @include('admin.notif')
            <!-- Page Heading -->
            <form class="form-horizontal" action="{{ Route('admin.submitsubkriteriaedit',$subkriteria->id)}}" method="post">
                {{csrf_field()}}
                {{method_field('put')}}
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="subkriteria" class="form-control" value="{{$subkriteria->subkriteria}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="kriteria" class="form-control" value="{{$subkriteria->kriteria}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bb" class="form-control" value="{{$subkriteria->bb}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="ba" class="form-control" value="{{$subkriteria->ba}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="nilai" class="form-control" value="{{$subkriteria->nilai}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
